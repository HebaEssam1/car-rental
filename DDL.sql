...
-- insert reservations
insert into `Reservation`(`CID`, `PlateID`, `Payment_way`, `Start_date`, `End_date`,Pay_status,Pickup) 
values (450,123556,'Credit card','2021-04-10','2021-04-20',1,0),
(870,139000,'Debit card','2022-04-11','2022-04-21',1,0),
(233,102900,'Credit card','2022-04-12','2022-04-22',1,0);
